...
const EditTiposDeUsoScreen = () => {
 ...
 useEffect(() => {
  ...
  function fetchtiposDeUso() {
    ...
    .then(response => {
        setNome(response.data.tiposDeUso.nome)
    })
    .catch(error => {
        console.error('Erro:', error);
    }); 
            ...
            <div className='flex flex-col items-center justify-evenly w-[100%]'>
                <div className='w-[100%] h-[10vh]  flex '>
                      <div className='w-[50%] h-[60vh] flex flex-col justify-evenly items-center '>
                        ...
                        <button className='w-[30%] ml-[50%] border border-[#70AD47]' onClick={updateTiposDeUso }>Salvar</button>
                      </div>
                </div> 
            </div>
          </div>
...
export default EditTiposDeUsoScreen