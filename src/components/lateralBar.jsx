  ...
  return (
    ...
    <div className='flex flex-col bg-[#ffffff1e]  w-[100%]  h-[80%]   items-center'>
      <div className='flex flex-col  h-[60%]  w-[90%]  justify-evenly '>
          ...
          <Link to={'/Diferenciais'} className={`hover:cursor-pointer hover:font-bold text-white ${screen === 'Diferenciais' ? 'font-bold ': 'font-normal'}`}>Diferenciais</Link>
          ...
          <Link  to={'/Empreendimentos'} className={`hover:cursor-pointer hover:font-bold text-white ${screen === 'Empreendimentos' ? 'font-bold ': 'font-normal'}`}>Empreendimentos</Link>
          {role === 'admin' ? (
            <>
